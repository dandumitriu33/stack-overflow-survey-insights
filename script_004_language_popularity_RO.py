...
def calculate_language_popularity_percentage_RO_2011():
    ...
    utils.write_popular_languages_dictionary_RO_to_file(output_dictionary, 2011)

    print('2011 RO: OK')


def calculate_language_popularity_percentage_RO_2012():
    ...
    utils.write_popular_languages_dictionary_RO_to_file(output_dictionary, 2012)

    print('2012 RO: OK')

    

def calculate_language_popularity_percentage_RO_2013():
    ...
    utils.write_popular_languages_dictionary_RO_to_file(output_dictionary, 2013)

    print('2013 RO: OK')


def calculate_language_popularity_percentage_RO_2014():
    with open('../data/developer_survey_2014/survey_results_public.csv') as f:
        ...
        for line in csv_reader:
            if line[verification_question] == '' and line[question] == '':
                ...
                if line['What Country do you live in?'] == 'Romania':
                    counts['Yes'] += 1                
                    for language in language_cells:
                        if line[language] != '':
                            try:
    ...
    utils.write_popular_languages_dictionary_RO_to_file(output_dictionary, 2014)
...
def calculate_language_popularity_percentage_RO_2015():
    ...
    utils.write_popular_languages_dictionary_RO_to_file(output_dictionary, 2015)

    print('2015 RO: OK')

def calculate_language_popularity_percentage_RO_2016():
    ...
    utils.write_popular_languages_dictionary_RO_to_file(output_dictionary, 2016)

    print('2016 RO: OK')


def calculate_language_popularity_percentage_RO_2017():
    ...
    utils.write_popular_languages_dictionary_RO_to_file(output_dictionary, 2017)

    print('2017 RO: OK')


def calculate_language_popularity_percentage_RO_2018():
    ...
    utils.write_popular_languages_dictionary_RO_to_file(output_dictionary, 2018)
...
def calculate_language_popularity_percentage_RO_2019():
    ...
    utils.write_popular_languages_dictionary_RO_to_file(output_dictionary, 2019)

    print('2019 RO: OK')


if __name__ == "__main__":
    calculate_language_popularity_percentage_RO_2011()
    calculate_language_popularity_percentage_RO_2012()
    calculate_language_popularity_percentage_RO_2013()
    calculate_language_popularity_percentage_RO_2014()
    calculate_language_popularity_percentage_RO_2015()
    calculate_language_popularity_percentage_RO_2016()
    calculate_language_popularity_percentage_RO_2017()
    calculate_language_popularity_percentage_RO_2018()
    calculate_language_popularity_percentage_RO_2019()