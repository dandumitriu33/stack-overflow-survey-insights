...
def write_popular_languages_dictionary_US_to_file(input_dictionary, year):
    """Writes the dicitionary to the .csv file to prepare for charts.
    If the year is 2011, the process is 'w' in order to write the headers.
    The rest of the years are 'a'.
    ...
    input_dictionary['year'] = year
    if year == 2011:
        with open('results/003_language_popularity_US.csv', 'w', newline='') as f:
            fieldnames=['year', 'ABAP', 'ActionScript', 'Assembly', 'Bash/Shell/PowerShell', 'C', 'C#', 'C++', 'Cassandra', 
                        'Clojure', 'Cobol', 'CoffeeScript', 'ColdFusion', 'Common Lisp', 'Cordova', 'D', 'Dart', 
                        'Delphi', 'Drupal', 'Elixir', 'Erlang', 'F#', 'Fortran', 'Go', 'Groovy', 'HTML/CSS', 'Hack', 
                        'Hadoop', 'Haskell', 'Java', 'JavaScript', 'Julia', 'Kotlin', 'LAMP', 'Lua', 'MATLAB', 'MongoDB',
        ...
        with open('results/003_language_popularity_US.csv', 'a', newline='') as f:
            fieldnames=['year', 'ABAP', 'ActionScript', 'Assembly', 'Bash/Shell/PowerShell', 'C', 'C#', 'C++', 'Cassandra', 
                        'Clojure', 'Cobol', 'CoffeeScript', 'ColdFusion', 'Common Lisp', 'Cordova', 'D', 'Dart', 
                        'Delphi', 'Drupal', 'Elixir', 'Erlang', 'F#', 'Fortran', 'Go', 'Groovy', 'HTML/CSS', 'Hack', 
                        'Hadoop', 'Haskell', 'Java', 'JavaScript', 'Julia', 'Kotlin', 'LAMP', 'Lua', 'MATLAB', 'MongoDB',
...
def write_popular_languages_dictionary_RO_to_file(input_dictionary, year):
    """Writes the dicitionary to the .csv file to prepare for charts.
    If the year is 2011, the process is 'w' in order to write the headers.
    The rest of the years are 'a'.
    ...
    input_dictionary['year'] = year
    if year == 2011:
        with open('results/004_language_popularity_RO.csv', 'w', newline='') as f:
            fieldnames=['year', 'ABAP', 'ActionScript', 'Assembly', 'Bash/Shell/PowerShell', 'C', 'C#', 'C++', 'Cassandra', 
                        'Clojure', 'Cobol', 'CoffeeScript', 'ColdFusion', 'Common Lisp', 'Cordova', 'D', 'Dart', 
                        'Delphi', 'Drupal', 'Elixir', 'Erlang', 'F#', 'Fortran', 'Go', 'Groovy', 'HTML/CSS', 'Hack', 
                        'Hadoop', 'Haskell', 'Java', 'JavaScript', 'Julia', 'Kotlin', 'LAMP', 'Lua', 'MATLAB', 'MongoDB',
        ...
        with open('results/004_language_popularity_RO.csv', 'a', newline='') as f:
            fieldnames=['year', 'ABAP', 'ActionScript', 'Assembly', 'Bash/Shell/PowerShell', 'C', 'C#', 'C++', 'Cassandra', 
                        'Clojure', 'Cobol', 'CoffeeScript', 'ColdFusion', 'Common Lisp', 'Cordova', 'D', 'Dart', 
                        'Delphi', 'Drupal', 'Elixir', 'Erlang', 'F#', 'Fortran', 'Go', 'Groovy', 'HTML/CSS', 'Hack', 
                        'Hadoop', 'Haskell', 'Java', 'JavaScript', 'Julia', 'Kotlin', 'LAMP', 'Lua', 'MATLAB', 'MongoDB',
...
def write_popular_languages_dictionary_HU_to_file(input_dictionary, year):
    """Writes the dicitionary to the .csv file to prepare for charts.
    If the year is 2011, the process is 'w' in order to write the headers.
    The rest of the years are 'a'.
    ...
    input_dictionary['year'] = year
    if year == 2011:
        with open('results/005_language_popularity_HU.csv', 'w', newline='') as f:
            fieldnames=['year', 'ABAP', 'ActionScript', 'Assembly', 'Bash/Shell/PowerShell', 'C', 'C#', 'C++', 'Cassandra', 
                        'Clojure', 'Cobol', 'CoffeeScript', 'ColdFusion', 'Common Lisp', 'Cordova', 'D', 'Dart', 
                        'Delphi', 'Drupal', 'Elixir', 'Erlang', 'F#', 'Fortran', 'Go', 'Groovy', 'HTML/CSS', 'Hack', 
                        'Hadoop', 'Haskell', 'Java', 'JavaScript', 'Julia', 'Kotlin', 'LAMP', 'Lua', 'MATLAB', 'MongoDB',
        ...
        with open('results/005_language_popularity_HU.csv', 'a', newline='') as f:
            fieldnames=['year', 'ABAP', 'ActionScript', 'Assembly', 'Bash/Shell/PowerShell', 'C', 'C#', 'C++', 'Cassandra', 
                        'Clojure', 'Cobol', 'CoffeeScript', 'ColdFusion', 'Common Lisp', 'Cordova', 'D', 'Dart', 
                        'Delphi', 'Drupal', 'Elixir', 'Erlang', 'F#', 'Fortran', 'Go', 'Groovy', 'HTML/CSS', 'Hack', 
                        'Hadoop', 'Haskell', 'Java', 'JavaScript', 'Julia', 'Kotlin', 'LAMP', 'Lua', 'MATLAB', 'MongoDB',
