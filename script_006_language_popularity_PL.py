...
def calculate_language_popularity_percentage_PL_2011():
    ...
    utils.write_popular_languages_dictionary_PL_to_file(output_dictionary, 2011)

    print('2011 PL: OK')


def calculate_language_popularity_percentage_PL_2012():
    ...
    utils.write_popular_languages_dictionary_PL_to_file(output_dictionary, 2012)

    print('2012 PL: OK')

    

def calculate_language_popularity_percentage_PL_2013():
    ...
    utils.write_popular_languages_dictionary_PL_to_file(output_dictionary, 2013)

    print('2013 PL: OK')


def calculate_language_popularity_percentage_PL_2014():
    with open('../data/developer_survey_2014/survey_results_public.csv') as f:
        ...
        for line in csv_reader:
            if line[verification_question] == '' and line[question] == '':
                ...
                if line['What Country do you live in?'] == 'Poland':
                    counts['Yes'] += 1                
                    for language in language_cells:
                        if line[language] != '':
                            try:
    ...
    utils.write_popular_languages_dictionary_PL_to_file(output_dictionary, 2014)

    print('2014 PL: OK')

 
def calculate_language_popularity_percentage_PL_2015():
    ...
    utils.write_popular_languages_dictionary_PL_to_file(output_dictionary, 2015)

    print('2015 PL: OK')

def calculate_language_popularity_percentage_PL_2016():
    ...
    utils.write_popular_languages_dictionary_PL_to_file(output_dictionary, 2016)

    print('2016 PL: OK')


def calculate_language_popularity_percentage_PL_2017():
    ...
    utils.write_popular_languages_dictionary_PL_to_file(output_dictionary, 2017)

    print('2017 PL: OK')


def calculate_language_popularity_percentage_PL_2018():
    ...
    utils.write_popular_languages_dictionary_PL_to_file(output_dictionary, 2018)

    print('2018 PL: OK')


def calculate_language_popularity_percentage_PL_2019():
    ...
    utils.write_popular_languages_dictionary_PL_to_file(output_dictionary, 2019)

    print('2019 PL: OK')


if __name__ == "__main__":
    calculate_language_popularity_percentage_PL_2011()
    calculate_language_popularity_percentage_PL_2012()
    calculate_language_popularity_percentage_PL_2013()
    calculate_language_popularity_percentage_PL_2014()
    calculate_language_popularity_percentage_PL_2015()
    calculate_language_popularity_percentage_PL_2016()
    calculate_language_popularity_percentage_PL_2017()
    calculate_language_popularity_percentage_PL_2018()
    calculate_language_popularity_percentage_PL_2019()